...
def get_groups(lines):
    grouped_lines = [l.splitlines() for l in ''.join(lines).split('\n\n')]
    return grouped_lines


def sums_from_groups(groups):
    return sum([sum_from_group(g) for g in groups])
